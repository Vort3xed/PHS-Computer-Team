  ...
  return (
    <footer className={`${Styles.footer} container-70`}>
        ...
        <div className="flex-2 md:flex-1">
          <div className="mb-3 flex flex-col">
            ...
            <h4 className="text-lg font-extralight">
              <a href="mailto:contact@phscomputerteam.org">contact@phscomputerteam.org</a>
            </h4>
          </div>
          <div className="my-3 flex flex-col">
            <h3 className="text-2xl">Social Media</h3>
            <h4 className="text-lg font-extralight">
            <a href="https://www.instagram.com/phscomputerteam/" target="_blank" rel='noreferrer'>www.instagram.com/phscomputerteam/</a> <br />
            <a href="https://github.com/phscomputerteam" target="_blank" rel='noreferrer'>github.com/phscomputerteam</a> <br />
            </h4>
          </div>
        </div>
      ...
      <div className={Styles.copyrightBottom}>
        <h6>
          © {new Date().getFullYear()} PHS Computer Team. All rights
          reserved.
        </h6>
